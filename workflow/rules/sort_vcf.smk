...
rule sort_vcf:
    input:
        vcf="filtering/add_multi_snv_in_codon/{file}.vcf.gz",
        vcf_indexed="filtering/add_multi_snv_in_codon/{file}.vcf.gz.tbi",
    output:
        vcf=temp("filtering/add_multi_snv_in_codon/{file}.sorted.vcf.gz"),
    log:
        "filtering/add_multi_snv_in_codon/{file}.sorted.vcf.gz.log",
    benchmark:
        repeat(
            "filtering/add_multi_snv_in_codon/{file}.sorted.vcf.gz.benchmark.tsv",
    ...
    conda:
        "../envs/sort_vcf.yaml"
    message:
        "{rule}: Sort vcf filtering/add_multi_snv_in_codon/{wildcards.file}.vcf.gz"
    wrapper:
